...
const CalculationTable = () => {
    ...
    const downloadTableData = () => {
        ...
        const data = [
            ...
            ["Parking usage factor (Table A)", "P", parseInt(inputValuePz), parseInt(inputValuePa), parseInt(inputValuePb), parseInt(inputValuePc), parseInt(inputValuePd)],
            ...
            ["The Staff Exposure Factor (Table C)", "E", parseInt(inputStaffEz), parseInt(inputStaffEa), parseInt(inputStaffEb), parseInt(inputStaffEc), parseInt(inputStaffEd)],
            ["The Vehicle Type Factor (Table B)", "T", parseInt(inputVTypeTz), parseInt(inputVTypeTa), parseInt(inputVTypeTb), parseInt(inputVTypeTc), parseInt(inputVTypeTd)],
